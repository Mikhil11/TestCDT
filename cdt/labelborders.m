function h = labelborders(place,varargin)
% This function labels borders of nations or US states.  This function does
...
% Double everything in case longitude range is 0 to 360: 
lat = [lat;lat]; 
lon = [lon;lon+360]; 
place = [place;place];

h = text(lon,lat,place,'clipping','on','vert','middle','horiz','center',varargin{:}); 
